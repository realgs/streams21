...
if __name__ == "__main__":
    ...
    while True:
        ...
        axes[0][0].plot(x, AVERAGE_USER_BUY_PRICE_BTC, color='blue', linestyle='dashed')
        axes[0][0].plot(x, AVERAGE_USER_SELL_PRICE_BTC, color='orange', linestyle='dashed')
        ...
        axes[0][1].plot(x, AVERAGE_USER_BUY_PRICE_ETH, color='blue', linestyle='dashed')
        axes[0][1].plot(x, AVERAGE_USER_SELL_PRICE_ETH, color='orange', linestyle='dashed')
        ...
        axes[0][2].plot(x, AVERAGE_USER_BUY_PRICE_LSK, color='blue', linestyle='dashed', label='AVG.Buy' if i == 0 else "")
        axes[0][2].plot(x, AVERAGE_USER_SELL_PRICE_LSK, color='orange', linestyle='dashed', label='AVG.Sell' if i == 0 else "")
