...
def show_plots():
    ...
    for i in range(0,n):
        ...
        text1 = axis[0].text(1.02,0.5,'', transform=axis[0].transAxes)
        text11 = axis[0].text(1.02,0.4,'', transform=axis[0].transAxes)
        text111 = axis[0].text(1.02,0.3,'', transform=axis[0].transAxes)
        text1111 = axis[0].text(1.02,0.2,'', transform=axis[0].transAxes)
        text2 = axis[2].text(1.02,0.5,'', transform=axis[2].transAxes)
        text21 = axis[2].text(1.02,0.4,'', transform=axis[2].transAxes)
        text221 = axis[2].text(1.02,0.3,'', transform=axis[2].transAxes)
        text2221 = axis[2].text(1.02,0.2,'', transform=axis[2].transAxes)
